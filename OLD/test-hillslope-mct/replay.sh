...
# Created 2023-05-16 08:44:22

CASEDIR="/glade/u/home/marielj/cesm-hillslope/test-hillslope-mct"

/glade/u/home/marielj/ctsm-hillslope_hydrology/cime/scripts/create_newcase --case "${CASEDIR}" --compset 2000_DATM%1PT_CLM50%SP_SICE_SOCN_MOSART_SGLC_SWAV --user-mods-dir /glade/u/home/marielj/cesm2.1.3/components/clm/tools/PTCLM/mydatafiles/1x1pt_US-MBP --res CLM_USRDAT --project UMIN0008 --run-unsupported --driver mct
