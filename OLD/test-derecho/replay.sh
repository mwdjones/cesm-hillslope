...
# Created 2024-03-21 11:34:36

CASEDIR="/glade/u/home/marielj/cesm-hillslope/test-derecho"

/glade/u/home/marielj/ctsm-hillslope_hydrology/cime/scripts/create_newcase --case "${CASEDIR}" --compset 2000_DATM%1PT_CLM50%SP_SICE_SOCN_SROF_SGLC_SWAV --res CLM_USRDAT --project UMIN0008 --run-unsupported --driver mct
