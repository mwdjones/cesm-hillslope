...
params = {'MEDLYNSLOPE' : [1, 3, 5, 7, 9, 11],
          'SLOPEBETA' : [-1000, -100, -10, -3, 0, 10, 10],
          'BASEFLOW': [0, 2, 4, 6, 8],
...
#Clone case 
CLONE_DIR = '/glade/u/home/marielj/cesm-hillslope/hillslope-bayes-opt-seanmods'
#PARAM file
PARAM_FILE = '/glade/u/home/marielj/cesm-hillslope/calib-surf-files/clm50_params.c240105.nc'
#SURF file
SURF_FILE = '/glade/u/home/marielj/cesm-hillslope/calib-surf-files/surfdata_1x1pt_US-MBP_hist_16pfts_Irrig_CMIP6_simyr2000_HAND_3_col_hillslope_seanmods.nc'
...
for PARAM in params:
    for i in range(0, len(params[PARAM])):
        ...
        #Run start date
        #Give 7 years for transient spinup
        ...
        f = open(file_name, 'w')
        f.write("fsurdat = '/glade/u/home/marielj/cesm-hillslope/calib-surf-files/surfdata_1x1pt_US-MBP_hist_16pfts_Irrig_CMIP6_simyr2000_HAND_3_col_hillslope_seanmods.nc'\n") 
        f.write("finidat = '/glade/u/home/marielj/cesm-hillslope/spinup-runs/restarts/derecho-spinup-seanmods.clm2.r.0201-01-01-00000.nc'\n")
        ...
        f.write("hist_fincl2 = 'RAIN', 'H2OSNO', 'QSOIL', 'QVEGT', 'QSNOMELT', 'QRUNOFF', 'ZWT', 'ZWT_PERCH', 'SNOW', 'TSA', 'SOILICE', 'QINFL', 'QOVER', 'H2OSOI', 'TSOI', 'FSAT', 'FSNO', 'QICE', 'TREFMNAV', 'TREFMXAV', 'watsat'\n")
        f.write("hist_fincl3 = 'RAIN', 'H2OSNO', 'QSOIL', 'QVEGT', 'QSNOMELT', 'QRUNOFF', 'ZWT', 'ZWT_PERCH', 'SNOW', 'TSA', 'SOILICE', 'QINFL', 'QOVER', 'H2OSOI', 'TSOI', 'FSAT', 'FSNO', 'QICE', 'TREFMNAV', 'TREFMXAV', 'watsat'\n")
        f.write("hist_fincl4 = 'RAIN', 'H2OSNO', 'QSOIL', 'QVEGT', 'QSNOMELT', 'QRUNOFF', 'ZWT', 'ZWT_PERCH', 'SNOW', 'TSA', 'SOILICE', 'QINFL', 'QOVER', 'H2OSOI', 'TSOI', 'FSAT', 'FSNO', 'QICE', 'TREFMNAV', 'TREFMXAV', 'watsat'\n")
        ...
        if(PARAM == 'FFF'):
            ...
            change_surf_param('FMAX', 0.3746, 0, SURF_FILE)
            change_param('slopebeta', -3, PARAM_FILE) 
            change_pft_param('medlynslope', 13,  5.25, PARAM_FILE)
        ...
        if(PARAM == 'MEDLYNSLOPE'):
            #change value - specifically for arctic grass [14]
            change_pft_param('medlynslope', 13, params[PARAM][i], PARAM_FILE)
            #Set others back to base
            change_param('fff', 0.5, PARAM_FILE) 
            change_param('slopebeta', -3, PARAM_FILE) 
            change_surf_param('FMAX', 0.3746, 0, SURF_FILE)
