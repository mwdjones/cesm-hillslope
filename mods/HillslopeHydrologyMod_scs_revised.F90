...
! MUST agree with name in namelist and read statement
  ...
  subroutine HillslopeNPftPerColumn(bounds)
    ...
    ! note: gridcell must have nonzero weights on surface data file for all desired pfts
    !
    ! !USES
    use LandunitType    , only : lun
    use ColumnType      , only : col
    ...
    integer :: p1, p2
    ! desired pft types
    integer, parameter :: p1_col1=1
    integer, parameter :: p2_col1=6
    integer, parameter :: p1_col2=2
    integer, parameter :: p2_col2=12
    integer, parameter :: p1_col3=5
    integer, parameter :: p2_col3=13
