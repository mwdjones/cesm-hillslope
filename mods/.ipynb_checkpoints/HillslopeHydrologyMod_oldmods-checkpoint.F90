    ...
    do c = bounds%begc,bounds%endc
       if (col%is_hillslope_column(c)) then
          ...
          if((c-bounds%begc+1) == 1) then
             ...
             frac2 = 0.0_r8 
             frac3 = 0.60_r8
             frac4 = (1.0_r8 - frac1 - frac2 - frac3)
             ! 1st patch
             patch%wtcol(col%patchi(c)  +0) = sum_wtcol * frac1
             patch%wtlunit(col%patchi(c)+0) = sum_wtlun * frac1
             patch%wtgcell(col%patchi(c)+0) = sum_wtgrc * frac1
             ! 2nd patch
             patch%wtcol(col%patchi(c)  +1) = sum_wtcol * frac2
             patch%wtlunit(col%patchi(c)+1) = sum_wtlun * frac2
             patch%wtgcell(col%patchi(c)+1) = sum_wtgrc * frac2
             ! 3rd patch
             patch%wtcol(col%patchi(c)  +2) = sum_wtcol * frac3
             patch%wtlunit(col%patchi(c)+2) = sum_wtlun * frac3
             patch%wtgcell(col%patchi(c)+2) = sum_wtgrc * frac3
             ! 4th patch
             patch%wtcol(col%patchi(c)  +3) = sum_wtcol * frac4
             patch%wtlunit(col%patchi(c)+3) = sum_wtlun * frac4
             patch%wtgcell(col%patchi(c)+3) = sum_wtgrc * frac4
          endif
          ! column 2 - bog
